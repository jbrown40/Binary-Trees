...
public class treeNode {
	...
	public int inorder(int i, int[] res){
		i = inorderHelper(this, res, i);
		return i;
	}

	public int inorderHelper(treeNode t, int[] res, int i) {
		if (t != null) {
			if (t.left != null) {
				inorderHelper(t.left, res, i);
			}
			res[i] = t.iData;
			i++;
			if (t.right != null) {
				inorderHelper(t.right, res, i);
			}
		}
